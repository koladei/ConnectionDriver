...
/**
 * Description of CachedDataConnectionDriver
 *
 * @author Kolade.Ige
 */
class CachedDataConnectionDriver extends MiddlewareConnectionDriver {

    /**
     * Instantiates and returns an instance of a CachedDataConnectionDriver.
     *
...
class CachedEntity extends MiddlewareEntity {
    
}

class CachedComplexEntity extends MiddlewareComplexEntity {
    
}

class CachedEntityCollection extends MiddlewareEntityCollection {
